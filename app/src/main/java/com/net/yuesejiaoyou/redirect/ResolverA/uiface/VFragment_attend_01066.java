...
public class VFragment_attend_01066 extends Fragment implements OnClickListener, SwipeRefreshLayout.OnRefreshListener {
	...
	public void initdata() {
		...
		//userid，页数，男女
		String[] params = {"1", pageno+"",gender};
		//实例化线程b，传递参数 mode,params,handler;
	...
	public void onRefresh() {
        ...
        String mode1="activity_search";
        String []params1={""};
        //实例化线程b1，传递参数model,paramsl,handler;
        UsersThread_01158A b1=new UsersThread_01158A(mode1,params1,handler);
        Thread thread1=new Thread(b1.runnable);
        thread1.start();
	}
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
                ...
                case 201:
                    ...
                    if (list==null){
                        Toast.makeText(mContext,"NetWork Connection Exception",Toast.LENGTH_SHORT).show();
                        return;
                    }
                            ...
                            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                                ...
                                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                                    if (lastVisibleItem + 1 == adapter.getItemCount()) {
                                        ...
                                        if (pageno==totlepage  || totlepage==0) {
