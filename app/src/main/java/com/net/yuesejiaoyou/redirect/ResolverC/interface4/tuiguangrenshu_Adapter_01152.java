...
public class tuiguangrenshu_Adapter_01152 extends BaseAdapter{
	...
	public tuiguangrenshu_Adapter_01152(Context context, ListView mlistview,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		LogDetect.send(LogDetect.DataType.specialType, "tuiguang_Adapter_01152:", "适配器开始++++++++++");
					...
					if(articles.get(0).getPhoto().contains("http")){
						ImageLoader.getInstance().displayImage(articles.get(position).getPhoto(),holderView.touxiang,options);
					}
