        ...
        TimerTask mTask = new TimerTask() {
            ...
            public void run() {
                ...
                try {
                    ...
                    boolean isalive = SystemUtils.isAPPALive(PlayerMusicService.this, "com.net.yuesejiaoyou.redirect.ResolverD.interface4");
                    boolean islive=CheckUtil.isClsRunning(PlayerMusicService.this,"com.net.yuesejiaoyou.redirect.ResolverD.interface4","com.net.yuesejiaoyou.activity.MainActivity");
