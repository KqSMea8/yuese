...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa1.smack.IQProvider;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa1.smack.ProviderManager;
...
public class PacketParserUtils {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (elementName.equals("status")) {
                    presence.setStatus(parser.getText());
                }
                    ...
                    String modeText = parser.getText();
                    try {
    ...
    public static IQ parseIQ(XmlPullParser parser, XMPPConnection connection) throws Exception {
        ...
        if (iqPacket == null) {
            if (IQ.Type.GET == type || IQ.Type.SET == type ) {
                ...
                ////////////////////------------------>>>>>>>>
                LogDetect.send(DataType.specialType,"xmpp内二层:","8+"+iqPacket.getType());
                ////////////////////------------------>>>>>>>>
                connection.processPacket(iqPacket);
                return iqPacket;
            }
            else {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                if (parser.getName().equals("item")) {
                    ...
                    final String groupName = parser.getText();
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                if (parser.getName().equals("resource")) {
                    bind.setResource(parser.getText());
                }
                else if (parser.getName().equals("jid")) {
                    bind.setJid(parser.getText());
                }
            } else if (eventType == XmlPullParser.END_TAG) {
    ...
    private static Object decode(Class<?> type, String value) throws Exception {
        ...
        ////////////////////------------------>>>>>>>>
        LogDetect.send(DataType.specialType,"xmpp内二层:","7+"+type.getName());
        ////////////////////------------------>>>>>>>>
        return null;
    }
