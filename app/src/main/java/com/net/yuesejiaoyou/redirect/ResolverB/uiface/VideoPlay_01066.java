...
public class VideoPlay_01066 extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new FragAdapter(VideoPlay_01066.this.getSupportFragmentManager(), fragments);
...
//		});
		...
		LogDetect.send(LogDetect.DataType.specialType,"downorup:","444444444444444");
	}
