 ...
 * 本类是查询个人中M普通用户的数据
 ****************************************************************/
public class vliao_Gerenzhongxin_1152 extends Fragment implements OnClickListener{
	...
	public void onClick(View arg0) {
		...
		switch (id) {
			...
			case R.id.touxiang:
				intent = new Intent();
				intent.setClass(mContext, ModifyInformation_01152.class);//修改头像
				startActivity(intent);
				break;
			////////////////////////////////
			...
			case R.id.renzheng:
				if (myrenzheng>0){
					...
					intent = new Intent();
					intent.setClass(mContext, Anchor_guide_01162.class);//“成为主播”
					startActivity(intent);
				}
				break;
			////////////////////////////////
