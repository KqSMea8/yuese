...
import com.net.yuesejiaoyou.redirect.ResolverA.interface4.HelpManager_01158A;

import java.io.IOException;
import java.util.ArrayList;


public class UsersManage_01158A {


	HelpManager_01158A helpmanager = null;
	OkHttp okhttp=null;
	public UsersManage_01158A() {
		//httpclient = new HttpClientManage();
		okhttp=new OkHttp();
		helpmanager = new HelpManager_01158A();
	}
	...
	public ArrayList<photo_01162> activity_search(String[] params) throws IOException {
		String a = "ar?mode=A-user-search&mode2=activity_search";//含有两个数据用户名和密码
		String json = okhttp.requestPostBySyn(a, params);
	...
	/*public String xfliaotian(String[] params){
		String a = "ar?mode=A-user-mod&mode2=xfliaotian";
		String json = okhttp.requestPostBySyn(a,params);
		return json;
	}*/
