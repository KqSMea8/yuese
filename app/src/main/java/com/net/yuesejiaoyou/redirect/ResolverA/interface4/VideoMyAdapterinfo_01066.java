...
import com.net.yuesejiaoyou.redirect.ResolverB.uiface.VideoPlayPrivate_01066;
...
public class VideoMyAdapterinfo_01066 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private Typeface tf;
    public VideoMyAdapterinfo_01066(List<String> datas, Context context, boolean hasMore, List<Videoinfo> articles) {
        this.datas = datas;
        ...
        if (holder instanceof NormalHolder) {
            ...
            ((NormalHolder) holder).xyitem.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    /////////////////////////////
                    LogDetect.send(LogDetect.DataType.specialType,"A区个人详情页点击私人视频 转2调 B区","00000");
                    //////////////////////////////
                    Intent intent = new Intent(context, VideoPlayPrivate_01066.class);
...
//            }
            ...
            if (fadeTips){
                ...
                ((FootHolder) holder).tips.setText("——END——");
            }
