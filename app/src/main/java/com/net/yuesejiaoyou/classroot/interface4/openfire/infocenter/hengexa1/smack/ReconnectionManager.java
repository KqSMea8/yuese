...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa1.smack.XMPPException.StreamErrorException;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa1.smack.packet.StreamError;
...
public class ReconnectionManager extends AbstractConnectionListener {
    ...
    private boolean isReconnectionAllowed() {
        return !done && !connection.isConnected()
                && true/*connection.getConfiguration().isReconnectionAllowed()*/;
    }
                    ...
                    while (ReconnectionManager.this.isReconnectionAllowed()) {
                        ...
                        try {
                            if (ReconnectionManager.this.isReconnectionAllowed()) {
                                //connection.connect();
                                //LogDetect.send(LogDetect.DataType.specialType, "异常触发重新连接  ", "After connection.connect()");
...
//            }
    ...
    public void connectionClosedOnError(Exception e) {
        ...
        //LogDetect.send(DataType.specialType, "异常触发重新连接  ", "connectionClosedOnError()");
        if (this.isReconnectionAllowed()) {
            this.reconnect();
        }
    }
