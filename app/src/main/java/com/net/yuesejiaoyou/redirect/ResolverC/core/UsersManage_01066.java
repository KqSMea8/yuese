...
public class UsersManage_01066 {
	HelpManager_01066 helpmanager = null;
	OkHttp okhttp=null;
	public UsersManage_01066() {
		//httpclient = new HttpClientManage();
		okhttp=new OkHttp();
		helpmanager = new HelpManager_01066();
	...
	public String fgetcode(String[] params){
		String a = "ar?mode=A-user-search&mode2=fgetcode";//含有两个数据用户名和密码
		String json = okhttp.requestPostBySyn(a, params);
		return json;
	}
	...
	public String guanzhu(String[] params){
		String a = "xunyuan?mode=A-user-mod&mode2=guanzhu";//含有两个数据用户名和密码
		String json = okhttp.requestPostBySyn(a, params);
		return json;
	}
	public String payvideo(String[] params){
		String a = "xunyuan?mode=A-user-mod&mode2=payvideo";//含有两个数据用户名和密码
		String json = okhttp.requestPostBySyn(a, params);
		return json;
	}
	...
	public Videoinfo video_info(String[] params){
		String a = "xunyuan?mode=A-user-search&mode2=video_info";
		String json = okhttp.requestPostBySyn(a, params);
