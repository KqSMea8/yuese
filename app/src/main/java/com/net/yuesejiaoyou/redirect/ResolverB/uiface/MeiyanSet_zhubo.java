                        ...
                        new Downloader(Util.url + "/res/" + path + ".zip",
                                ...
                                new Downloader.DownloaderListener() {
                                    ...
                                    public void onError(final int code, final String reason) {
                                        ...
                                        MeiyanSet_zhubo.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(MeiyanSet_zhubo.this, "下载 "+name+"失败("+code+"): "+reason, Toast.LENGTH_SHORT).show();
...
//                        takeVideo();
//                }
                //Toast.makeText(MeiyanSet_zhubo.this, "点击保存参数", Toast.LENGTH_SHORT).show();
