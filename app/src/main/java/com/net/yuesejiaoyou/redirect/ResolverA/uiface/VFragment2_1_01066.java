...
import com.net.yuesejiaoyou.redirect.ResolverB.uiface.VideoPlay_01066;//对接B区
...
public class VFragment2_1_01066 extends Fragment implements OnClickListener, SwipeRefreshLayout.OnRefreshListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		LogDetect.send(LogDetect.DataType.specialType, "this0111111111111111", "??222222");
		return view;
	}
...
//									}, 500);
						...
						adapter.setOnItemClickLitsener(new VideoMyAdapter_01066.onItemClickListener() {
							...
							public void onItemClick(View view, int position) {
								...
								LogDetect.send(LogDetect.DataType.specialType, "01160 video:", "读短视频");
							}
