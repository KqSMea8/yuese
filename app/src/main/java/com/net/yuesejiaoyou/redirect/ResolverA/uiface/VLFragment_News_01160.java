 ...
 **************************************/
@SuppressLint("NewApi")
public class VLFragment_News_01160 extends Fragment implements OnClickListener  {
	private String id;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		/*tv_time = (TextView)mBaseView.findViewById(R.id.tv_time);
		
		content = (TextView)mBaseView.findViewById(R.id.content);*/
