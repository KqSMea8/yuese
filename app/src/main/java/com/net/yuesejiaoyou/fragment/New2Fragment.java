...
import com.net.yuesejiaoyou.adapter.Find3Adapter;
...
public class New2Fragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    private RecyclerView recyclerView;
    private List<User_data> articles = new ArrayList<User_data>();
    private int pageno = 1;
    Find3Adapter adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new HorizontalDividerItemDecoration.Builder(getContext())
                ...
                .build());
        adapter = new Find3Adapter(getContext(), articles);
    ...
    public void getDatas() {
        OkHttpUtils
                .post(this)
                .url(type == 1 ? URL.URL_XUNYAN : URL.URL_NEW)
                .addParams("param1", "")
                .addParams("param2", pageno)
