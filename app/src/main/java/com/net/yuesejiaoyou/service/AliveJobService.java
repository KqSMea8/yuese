package com.net.yuesejiaoyou.service;
...
public class AliveJobService extends JobService {
    ...
    public static final String PACKAGE_NAME = "com.net.yuesejiaoyou";
    ...
    private Handler mHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            // 具体任务逻辑
            if(SystemUtils.isAPPALive(getApplicationContext(), PACKAGE_NAME)){
