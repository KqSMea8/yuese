...
public class HelpActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.tixing: //消息来电提醒
			intent = new Intent();
			intent.setClass(HelpActivity.this, bengkui_01066.class);//编辑资料
			startActivity(intent);
			break;
			
		case R.id.xinxi: //崩溃
			intent = new Intent();
			intent.setClass(HelpActivity.this, bengkui_01152.class);
			startActivity(intent);
			break;
			
		case R.id.qita: //意见反馈
			intent = new Intent();
			intent.setClass(HelpActivity.this, Vliao_yijianfankui_01168.class);
			startActivity(intent);
			break;
