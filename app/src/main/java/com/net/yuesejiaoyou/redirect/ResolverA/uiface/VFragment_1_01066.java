...
public class VFragment_1_01066 extends Fragment implements OnClickListener, SwipeRefreshLayout.OnRefreshListener {
...
//						if(a=true){
//							gridView.addItemDecoration(new Recycle_item(5));
//						}
//						a=false;
