...
public class ShareActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LogDetect.send(LogDetect.DataType.specialType, "ShareActivity:", "布局开始");
		setContentView(R.layout.activity_tuiguang_01152);
		LogDetect.send(LogDetect.DataType.specialType, "ShareActivity:", "开始=====");
		...
		LogDetect.send(LogDetect.DataType.specialType, "ShareActivity:", "结束=====");
		//直接开线程，不需要请求事件
		String mode = "tuiguang";
		String[] paramsMap = {Util.userid};
		LogDetect.send(LogDetect.DataType.specialType, "ShareActivity:", "参数=====");
...
//	}
	...
	public void onClick(View v) {
		...
		case R.id.daili: //申请代理
			intent=new Intent();
			intent.setClass(ShareActivity.this, Vliao_agmentup_01066.class);
			startActivity(intent);
			break;
		case R.id.tuiguang: //点击提取现金
//			intent=new Intent();
//			intent.setClass(ShareActivity.this, Wwjhuodongxiangqing_1152.class);
//			startActivity(intent);
        ...
        case R.id.quyu1: //点击提取现金
            intent=new Intent();
            intent.setClass(ShareActivity.this, tuiguangrenshu_01152.class);
            startActivity(intent);
//			Toast.makeText(ShareActivity.this,"该功能正在实现ing",Toast.LENGTH_SHORT).show();
            break;
        case R.id.quyu2: //点击提取现金
            intent=new Intent();
            intent.setClass(ShareActivity.this, Vliao_tjrwithdraw_01168.class);
            startActivity(intent);
//			Toast.makeText(ShareActivity.this,"该功能正在实现ing",Toast.LENGTH_SHORT).show();
            break;
		}
	...
	private Handler requestHandler = new Handler() {
		  ...
		  public void handleMessage(Message msg) {
		    switch (msg.what) {
		      ...
		      case 200:
		    		LogDetect.send(LogDetect.DataType.specialType, "ShareActivity:", "集合======");
				  ...
				  gongluetext.setText(Html.fromHtml("1.所有用户都可以参与分成计划；<br><br>2.通过自己分享的专属推广链接下载注册的用户，才算“我”推荐的用户；<br><br>3.推荐的用户充值即可获得充值金额"+list.get(0).getCash_onefee()+"%的分成奖励；<br><br>4.推荐的用户提现可以获得提现金额"+list.get(0).getDvcash_onefee()+"%的分成奖励；<br><br>5.活动的最终解释权归平台所有。"));
                    ...
                    break;
		      case 210:
		    	  LogDetect.send(LogDetect.DataType.specialType, "ShareActivity:", "适配器集合======");
					...
					LogDetect.send(LogDetect.DataType.specialType, "ShareActivity:", list1);
					adapter = new tuiguang_Adapter_01152(ShareActivity.this, listview, list1);
