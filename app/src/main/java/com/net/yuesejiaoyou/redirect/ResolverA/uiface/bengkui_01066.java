...
public class bengkui_01066 extends Activity implements OnClickListener {
	//自定义ID
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bengkui_01066);
	...
	public void showPopupspWindow_reservation(View parent) {
		// 加载布局
		LayoutInflater inflater = LayoutInflater.from(bengkui_01066.this);
		...
		WindowManager.LayoutParams lp = bengkui_01066.this.getWindow().getAttributes();
		lp.alpha = 0.5f;
		bengkui_01066.this.getWindow().setAttributes(lp);
