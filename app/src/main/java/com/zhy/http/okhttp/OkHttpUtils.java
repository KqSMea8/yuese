...
public class OkHttpUtils {
    ...
    public static PostFormBuilder post(Object tag) {
        return new PostFormBuilder(tag);
    }
    ...
    public static PostJsonBuilder postJson(Object tag) {
        return new PostJsonBuilder(tag);
    }
    ...
    public static DeteleBuilder delete() {
        return new DeteleBuilder();
    }
    ...
    public void sendFailResultCallback(final Call call, final Exception e, final Callback callback, final int id) {
        ...
        mPlatform.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (e.getMessage().equals("Socket closed") || e.getMessage().equals("Canceled")) {
                    callback.onAfter(id);
                } else {
    ...
    public void sendSuccessResultCallback(final Object object, final Callback callback, final int id) {
        ...
        mPlatform.execute(new Runnable() {
            @Override
            public void run() {
                LogUtil.i("okhttp", "onResponse: " + object);
