...
import com.net.yuesejiaoyou.fragment.User2Fragment;
import com.net.yuesejiaoyou.redirect.ResolverA.interface4.utils.AutoMessage;
import com.net.yuesejiaoyou.fragment.DynamicFragment;
import com.net.yuesejiaoyou.fragment.MessageFragment;
import com.net.yuesejiaoyou.fragment.MineFragment;
import com.net.yuesejiaoyou.fragment.UserFragment;
import com.net.yuesejiaoyou.fragment.ZhuboFragment;
import com.net.yuesejiaoyou.redirect.ResolverB.interface4.im.IMManager;
import com.net.yuesejiaoyou.redirect.ResolverD.interface4.BaseActivity;
import com.net.yuesejiaoyou.redirect.ResolverD.interface4.URL;
import com.net.yuesejiaoyou.utils.UpdateManager;
    ...
    public void changeSelect(int position) {
        ...
        switch (position) {
            case 0:
                ...
                if (BuildConfig.APK_SUFFIX.equals("-p")) {
                    ...
                    if (curFragment != null && curFragment == user2Fragment) {
                        return;
                    }
                    ivFirst.setImageResource(R.drawable.home2);
                    ivVideo.setImageResource(R.drawable.discover1);
                    ...
                    if (user2Fragment == null) {
                        ...
                        transaction.add(R.id.fl_content, user2Fragment);
                    } else {
                        transaction.show(user2Fragment);
                    }
                    transaction.commit();
                    curFragment = user2Fragment;
                }
