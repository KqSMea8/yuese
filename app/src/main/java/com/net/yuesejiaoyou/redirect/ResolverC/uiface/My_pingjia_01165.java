 ...
 * 本类是查询我的评价(消息页面)
 *************************************************************************************************/
public class My_pingjia_01165 extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_pingjia_01165);
			...
			case 200:
				...
				if (list != null && list.size() != 0) {
					...
					My_pingjia_ListAdapter_01165 adapter = new My_pingjia_ListAdapter_01165(
							My_pingjia_01165.this, listView, null, list,
							requestHandler);
