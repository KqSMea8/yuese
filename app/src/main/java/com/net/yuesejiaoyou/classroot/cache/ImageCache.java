...
public class ImageCache {
     ...
     * this includes disk access so this should not be executed on the MainActivity/UI thread.
     */
     ...
     * disk access so this should not be executed on the MainActivity/UI thread.
     */
    public void flush() 
    {
    }
