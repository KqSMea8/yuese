...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa1.smack.PacketCollector;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa1.smack.ReconnectionManager;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa1.smack.XMPPInputOutputStream;
...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.filer.IQReplyFilter;
...
public abstract class XMPPConnection {
    ...
    private long packetReplyTimeout = /*SmackConfiguration.getDefaultPacketReplyTimeout()*/5000;
    /** 
    ...
    protected void callConnectionClosedOnErrorListener(Exception e) {
    	...
    	ReconnectionManager listener=new ReconnectionManager(this);
            try {
            	//LogDetect.send(DataType.basicType,Utils.seller_id+"=phone="+Utils.android,"before connectionClosedOnError()");
    ...
    public   void sendPacket(Packet packet) throws NotConnectedException {
        ...
        //LogDetect.send(DataType.basicType,Utils.seller_id+"=phone="+Utils.android,"fromMode: "+fromMode);
        switch (fromMode) {
        case OMITTED:
            packet.setFrom(null);
            break;
     ...
     * @param connectionCreationListener a listener interested on new connections.
     */
    /*01066 public static void removeConnectionCreationListener(
            ConnectionCreationListener connectionCreationListener) {
     ...
     */
    /* 01066 protected static Collection<ConnectionCreationListener> getConnectionCreationListeners() {
     ...
     * @param connectionListener a connection listener.
     */
    /*01066 public void removeConnectionListener(ConnectionListener connectionListener) {
     ...
     * @return a collection of listeners interested on connection events.
     */
    /*01066 protected Collection<ConnectionListener> getConnectionListeners() {
        return connectionListeners;
    }*/
    /**
   ...
   public PacketCollector createPacketCollectorAndSend(IQ packet) throws NotConnectedException {
    ...
    private void firePacketInterceptors(Packet packet) {
        ////////////////////------------------>>>>>>>>
        LogDetect.send(DataType.specialType,"xmpp内二层:","4");
        ////////////////////------------------>>>>>>>>
        if (packet != null) {
    ...
    private class ListenerNotification implements Runnable {
        ...
        public void run() {
        	//LogDetect.send(DataType.noType, Utils.seller_id+"=phone="+Utils.android+"收到消息", "ListenerNotification");
    ...
    /*01066 protected void callConnectionConnectedListener() {
        for (ConnectionListener listener : getConnectionListeners()) {
            listener.connected(this);
        }
    }
