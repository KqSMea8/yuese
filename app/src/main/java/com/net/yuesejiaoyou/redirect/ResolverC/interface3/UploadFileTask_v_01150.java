 ...
 * @version 1.0
 */
public class UploadFileTask_v_01150 extends AsyncTask<String, Void, String> {
	//public static final String requestURL = "http://120.27.119.77:9001/uiface/UploadFileServlet";
	...
	public UploadFileTask_v_01150(Activity ctx, Handler handler) {
		this.context = ctx;
		//pdialog = ProgressDialog.show(context, "Uploading...", "The system is dealing with your request！");
	...
	protected void onPostExecute(String result) {
		...
		try {
            ...
            LogDetect.send("11", "传图进行中11");
			if (!imgurl.equals("0")) {
                LogDetect.send("111", "传图进行中111");
				handler.sendMessage(handler.obtainMessage(101, imgurl));
			} else {
	...
	protected String doInBackground(String... params) {
		...
		return UploadUtils.uploadFile(file, requestURL,user_id);
	}
