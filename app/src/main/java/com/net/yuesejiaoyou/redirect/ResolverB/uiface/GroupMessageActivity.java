		  ...
		  public boolean handleMessage(Message msg) {
		    ...
		    case 205:
				...
				if(json != null) {
					...
					Toast.makeText(GroupMessageActivity.this, "您没有粉丝", Toast.LENGTH_SHORT).show();
		    ...
		    case 20:
				...
				if(list != null && list.size() != 0){
					...
					Toast.makeText(GroupMessageActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
					finish();
				}else{
					Toast.makeText(GroupMessageActivity.this, "您没有粉丝", Toast.LENGTH_SHORT).show();
				}
	...
	public void onClick(View v) {
		...
		case R.id.queding:
			if (TextUtils.isEmpty(input.getText().toString())) {
				Toast.makeText(GroupMessageActivity.this, "请输入内容", Toast.LENGTH_SHORT).show();
				return;
			}else{
