...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.gif.AnimatedGifDrawable;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.gif.AnimatedImageSpan;
...
public class ExpressionUtil {
    ...
    public static View viewPagerItem(final Context context, int position, List<String> staticFacesList, int columns, int rows, final EditText editText) {
        ...
        View layout = inflater.inflate(R.layout.face_gridview_01160, null);//表情布局
