...
import com.net.yuesejiaoyou.redirect.ResolverC.interface1.UsersManageInOut_01066;

//import com.example.vliao.interface1.UsersManageInOut_01066;


public class UsersThread_01066 {
	private Handler handler;
	private UsersManageInOut_01066 usersManageInOut;
	private String state;
	private String[] params;

	public UsersThread_01066(String mode, String[] params, Handler handler) {
		this.usersManageInOut = new UsersManageInOut_01066();
		this.state = mode;
		this.params = params;
