...
public class UploadFileTask extends AsyncTask<String, Void, String> {
	...
	public static final String requestURL = Util.url+"/uiface/UploadFileServlet";
	/**
	...
	public UploadFileTask(Activity ctx, Handler handler) {
		this.context = ctx;
		pdialog = ProgressDialog.show(context, "正在上传...", "系统正在处理您的请求！");
	...
	protected void onPostExecute(String result) {
		...
		try {
			...
			if (!imgurl.equals("0")) {
				...
				LogDetect.send(LogDetect.DataType.specialType, "imgurl：===========================", imgurl);
