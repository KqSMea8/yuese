...
public class Vliao_MyWallet_01168 extends Activity implements OnClickListener {
		...
		switch (id) {
			...
			case R.id.recharge:
				if(Util.iszhubo.equals("0")){
					intent = new Intent();
					intent.setClass(Vliao_MyWallet_01168.this, Chongzhi_01178.class);//v币
					startActivity(intent);
				}else{
					Toast.makeText(Vliao_MyWallet_01168.this,"主播暂无此功能",Toast.LENGTH_SHORT).show();
				}
			break;
			//提现
			case R.id.withdrawal:
				if(Util.iszhubo.equals("1")){
					...
					Toast.makeText(Vliao_MyWallet_01168.this,"只有主播可以提现",Toast.LENGTH_SHORT).show();
				}
			break;
			//收入明细
