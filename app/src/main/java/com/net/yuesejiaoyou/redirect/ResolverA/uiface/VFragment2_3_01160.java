...
public class VFragment2_3_01160 extends Fragment implements OnClickListener, SwipeRefreshLayout.OnRefreshListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		String mode = "attention_videolist";
		//userid，页数，男女
		String[] params = {Util.userid, pageno+"",maxid+""};
		UsersThread_01160A b = new UsersThread_01160A(mode, params, handler);
