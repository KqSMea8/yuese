...
public class Vliao_tjrwithdraw_01168 extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.submitp:
			...
			if(bHasTixianAccount == false) {
				Toast.makeText(Vliao_tjrwithdraw_01168.this,"请先绑定提现账号",Toast.LENGTH_SHORT).show();
				break;
			}
			if(username.getText().toString().equals("")){
				Toast.makeText(Vliao_tjrwithdraw_01168.this,"请输入提现金额",Toast.LENGTH_SHORT).show();
                return;
			}
			...
			LogDetect.send(LogDetect.DataType.specialType, "用户提现的值01168",money_tx);
			 if (Double.parseDouble(username.getText().toString())>Double.parseDouble(moneyp)){
                 Toast.makeText(Vliao_tjrwithdraw_01168.this,"提现金额超出！",Toast.LENGTH_SHORT).show();
                 return;
             }else if(username.getText().toString().equals("0")){
					Toast.makeText(Vliao_tjrwithdraw_01168.this,"请输入提现金额！",Toast.LENGTH_SHORT).show();
					return;
			}else if(money_tx<cash_lower){
				Toast.makeText(Vliao_tjrwithdraw_01168.this,"提现金额必须在"+cash_lower+"元以上",Toast.LENGTH_SHORT).show();
				return;
			}
		...
		break;
			...
			case R.id.account_lay:
				...
				intent1.setClass(Vliao_tjrwithdraw_01168.this,vliao_shenqing_01152.class);
		    	  ...
		    	  /*String json = (String)msg.obj;
			    	try { //如果服务端返回1，说明个人信息修改成功了
						...
						if(jsonObject.getString("success").equals("1")){
							//提交成功
							Toast.makeText(Vliao_tjrwithdraw_01168.this, "提交成功", Toast.LENGTH_SHORT).show();
							finish();
						}else{
							//提交失败
							Toast.makeText(Vliao_tjrwithdraw_01168.this, "提交失败", Toast.LENGTH_SHORT).show();  
						}
					} catch (JSONException e) {
