...
public class Vliao_agmentup_01066 extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.vliao_agment_01066);
		//改变字体
	...
	public void onClick(View v) {
		...
		case R.id.queren:
			...
			if(wenbenneirong.equals("")||shoujihao.getText().toString().equals("")){
				Toast.makeText(Vliao_agmentup_01066.this, "内容不能为空!",
		    	  ...
		    	  String json = (String)msg.obj;
			    	try { //如果服务端返回1，说明个人信息修改成功了
						...
						if(jsonObject.getString("success").equals("1")){
							//提交成功
							Toast.makeText(Vliao_agmentup_01066.this, "提交成功", Toast.LENGTH_SHORT).show();
							finish();
						}else{
							//提交失败
							Toast.makeText(Vliao_agmentup_01066.this, "提交失败", Toast.LENGTH_SHORT).show();
						}
