...
public class yaoqingfensi_01152 extends Activity implements OnClickListener {
	//自定义ID
	...
	public void onClick(View v) {
		...
		case R.id.share:
			...
			shareHelp1.showShare(yaoqingfensi_01152.this,Util.invite_num);
			break;
		}
	}
		...
		public void handleMessage(Message msg) {
			...
			case 200:
				...
				if(list==null || list.size()==0){
		    		  Toast.makeText(yaoqingfensi_01152.this, "网络出错", Toast.LENGTH_SHORT).show();
		    		  break;
		    	  }
