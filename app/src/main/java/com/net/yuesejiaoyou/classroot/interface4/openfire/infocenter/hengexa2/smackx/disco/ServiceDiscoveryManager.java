 ...
 */
package com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smackx.disco;
...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.PacketExtension;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.PacketFilter;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.PacketListener;
...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.XMPPError;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.filer.PacketTypeFilter;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smackx.caps.EntityCapsManager;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smackx.disco.packet.DiscoverInfo;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smackx.disco.packet.DiscoverInfo.Identity;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smackx.disco.packet.DiscoverItems;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smackx.xdata.packet.DataForm;
...
public class ServiceDiscoveryManager extends Manager {
    ...
    private ServiceDiscoveryManager(XMPPConnection connection) {
        ...
        PacketListener packetListener = new PacketListener() {
            public void processPacket(Packet packet) throws NotConnectedException {
                ...
                ////////////////////------------------>>>>>>>>
                LogDetect.send(DataType.specialType,"xmpp内二层:","9");
                ////////////////////------------------>>>>>>>>
                ...
                if (discoverItems != null && discoverItems.getType() == IQ.Type.GET) {
                    ...
                    ////////////////////------------------>>>>>>>>
                    LogDetect.send(DataType.specialType,"xmpp内二层:","10");
                    ////////////////////------------------>>>>>>>>
                }
            }
        };
    ...
    public DiscoverInfo discoverInfo(String entityID) throws NoResponseException, XMPPErrorException, NotConnectedException {
        ...
        // returned
        // 01066 EntityCapsManager.NodeVerHash nvh = EntityCapsManager.getNodeVerHashByJid(entityID);
