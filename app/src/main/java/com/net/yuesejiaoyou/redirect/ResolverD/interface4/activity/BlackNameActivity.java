...
public class BlackNameActivity extends BaseActivity implements OnClickListener {
    ...
    protected int getContentView() {
        return R.layout.vliao_heimingdan_01168;
    }
                ...
                case 206:
                    ...
                    try { //如果服务端返回1，说明个人信息修改成功了
                        ...
                        if (jsonObject.getString("success").equals("1")) {
                            Toast.makeText(BlackNameActivity.this, "取消成功", Toast.LENGTH_SHORT).show();
                            String mode = "heimingdan";
                            String[] params = {Util.userid};
                            UsersThread_01168C b = new UsersThread_01168C(mode, params, handler);
                            Thread thread = new Thread(b.runnable);
                            ...
                            Toast.makeText(BlackNameActivity.this, "取消失败,请稍后充实", Toast.LENGTH_SHORT).show();
                        }
