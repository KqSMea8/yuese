...
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.Presence.Mode;
import com.net.yuesejiaoyou.classroot.interface4.openfire.infocenter.hengexa2.smack.Presence.Type;



/**
 * Base class for XMPP packets. Every packet has a unique ID (which is
 * automatically generated, but can be overridden). Optionally, the "to" and
 * "from" fields can be set.
 *
 * @author Matt Tucker
 */
public abstract class Packet {
	...
	//
	// /**
	// * Keeps track of the current increment, which is appended to the prefix
	// to
	// * forum a unique ID.
	// */
	...
	// ArrayList<PacketExtension>(packetExtensions));
	// }
	...
	protected static final String DEFAULT_LANGUAGE = java.util.Locale
			.getDefault().getLanguage().toLowerCase(Locale.US);
	 ...
	 * elementName is null, only the namespace is matched. Packet extensions are
	 * are arbitrary XML sub-documents in standard XMPP packets. By default, a
	 * DefaultPacketExtension instance will be returned for each extension.
	 * However, PacketExtensionProvider instances can be registered with the
	...
	public <PE extends PacketExtension> PE getExtension(String elementName,
			String namespace) {
		if (namespace == null) {
			return null;
		}
	...
	public boolean equals(Object o) {
		...
		// if (error != null ? !error.equals(packet.error) : packet.error !=
		// null) { return false; }
