					...
					if (!json.equals("")) {
						...
						try {
							...
							if(jsonObject1.getString("0").equals("已封号")){
								Toast.makeText(Vchat_login_01162.this, "您的账号出现违规操作已被冻结，有问题请联系客服.", Toast.LENGTH_SHORT).show();
								return;
							}
...
//												@Override
//												public void run() {
//													Toast.makeText(Vchat_login_01162.this, "网易云信登录成功", Toast.LENGTH_SHORT).show();
//												}
//											});
//										}
//
...
//												@Override
//												public void run() {
//													Toast.makeText(Vchat_login_01162.this, "网易云信登录失败", Toast.LENGTH_SHORT).show();
//												}
//											});
//										}
//									});
									...
									intent.setClass(Vchat_login_01162.this, MainActivity.class);
									startActivity(intent);
									finish();
								} else {
									Toast.makeText(Vchat_login_01162.this, "请检查手机号或密码", Toast.LENGTH_SHORT).show();
								}
							} catch (JSONException e) {
				...
				case 20000:
					...
					//Toast.makeText(Vchat_login_01162.this, "微信maps:"+maps.toString(), Toast.LENGTH_LONG).show();
				...
				case 502:
					...
					if (!json02.equals("")) {
						if (json02.contains("id")) {
							...
							Toast.makeText(Vchat_login_01162.this, "绑定手机号已存在", Toast.LENGTH_SHORT).show();
						}
					}else{
						Toast.makeText(Vchat_login_01162.this, "请检查网络连接", Toast.LENGTH_SHORT).show();
					}
					break;
				//////////////////////////
...
//									});
							...
							Toast.makeText(Vchat_login_01162.this, "邀请码不正确", Toast.LENGTH_SHORT).show();
						}
					}else{
						Toast.makeText(Vchat_login_01162.this, "请检查网络连接", Toast.LENGTH_SHORT).show();
					}
							...
							try {
								...
								if (!a.equals("")) {
									if(jsonObject.getString("is_banned").equals("1")){
										Toast.makeText(Vchat_login_01162.this,"您已被封禁",Toast.LENGTH_SHORT).show();
										return;
									}
									String name = jsonObject.getString("nickname");
									String headpic = jsonObject.getString("photo");
		...
		switch (id) {
			...
			case R.id.sign:
				...
				/*if (guojianum.getText().toString().equals("")) {  //country code
					Toast.makeText(Vchat_login_01162.this, "please enter your country code", Toast.LENGTH_LONG).show();
				} else*/
				if (TextUtils.isEmpty(edit1.getText().toString()) || !isPhoneNum) {  //country code
					Toast.makeText(Vchat_login_01162.this, "请输入有效的手机号", Toast.LENGTH_LONG).show();
				} else if (TextUtils.isEmpty(edit2.getText().toString())) {
					Toast.makeText(Vchat_login_01162.this, "请输入密码", Toast.LENGTH_LONG).show();
				} else {
			...
			case R.id.register:
				Intent intent = new Intent();
				intent.setClass(Vchat_login_01162.this, Vchat_register_01162.class);
				startActivity(intent);
				break;
		/*	case R.id.face_book:
			...
			case R.id.forget:
				...
				intent1.setClass(Vchat_login_01162.this, Vchat_forget1_01162.class);
			...
			case R.id.xieyi:
				...
				intent2.setClass(Vchat_login_01162.this,Agreement_01162.class);
	...
	private void showPopupspWindow_tuichu(View arg0) {
		...
		View convertView = LayoutInflater.from(Vchat_login_01162.this).inflate(R.layout.fb_loginpop_01162, null);
		...
		fb_sure.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if(fb_invitecode.getText().toString().equals("")){
					Toast.makeText(Vchat_login_01162.this,"请输入邀请码",Toast.LENGTH_LONG).show();
				}else{
