	...
	private class MsgOperReciver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (msgBody.contains("挂0断1邀2请")) {
				...
				zhuboRoomId = msgs[0].replaceAll("接0通1视2频","");
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				...
				case 260:
					Toast.makeText(guke.this, "对方拒绝了你的邀请", Toast.LENGTH_SHORT).show();
					//--------------------158---------------------
					//关闭音乐
					MusicUtil.stopPlay();
					//--------------------158---------------------
				...
				case 302:
					...
					break;
				case 303:
					isAccept = true;	// 收到接通视频
					final String timestamp = new Date().getTime() + "";
					//SimpleDateFormat sd = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
					final String message1 = "开0始1视2频" + Const.SPLIT + Const.ACTION_MSG_ONEINVITE
					...
					MusicUtil.stopPlay();
					//---------------------------------------------------------------------
					//Intent intent = new Intent(guke_bk.this,VideoChatViewActivity.class);
					//Intent intent = new Intent(guke_bk.this,AgoraChatActivity.class);
					Intent intent = new Intent(guke.this,AgoraRtcActivity.class);
...
//						@Override
//						public void run() {
//					Intent intent = new Intent(guke_bk.this, LiveRoomActivity.class);
//					intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
