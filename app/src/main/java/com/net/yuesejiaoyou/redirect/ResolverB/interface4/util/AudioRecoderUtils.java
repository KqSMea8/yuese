...
//            filePath = "";
        ...
        RecordInfo info = new RecordInfo(filePath, endTime- startTime);
        return info;    //endTime - startTime;
    }
    ...
    public static void playMusicFile(final String audioFile) {
...
//        final int frequence = 16000;// 8000;
...
//                    while (dis.available() > 0) {  //while (isPlaying && dis.available() > 0) {
//                        int i = 0;
...
//        }).start();
       ...
       public class RecordInfo {
    	...
    	public RecordInfo(String file, long time) {
    		this.filePath = file;
    		this.time = time;
    	}
    }
