        ...
        TimerTask mTask = new TimerTask() {
            ...
            public void run() {
                ...
                try {
                    ...
                    boolean isalive = SystemUtils.isAPPALive(PlayerMusicService1.this, "com.net.yuesejiaoyou.redirect.ResolverD.interface4");
                    boolean islive=CheckUtil.isClsRunning(PlayerMusicService1.this,"com.net.yuesejiaoyou.redirect.ResolverD.interface4","com.net.yuesejiaoyou.redirect.ResolverA.uiface.MainActivity");
