...
public class ConnectionConfiguration implements Cloneable {
	...
	public ConnectionConfiguration(String host, int port) {
		...
		init(host, ProxyInfo.forHttpProxy(host, port, null, null));
	}
	...
	protected void init(String serviceName, ProxyInfo proxy) {
		...
		// throw new
		// IllegalArgumentException("serviceName must not be the empty String");
		// }
	 ...
	 * {@link #setCustomSSLContext(SSLContext)} for SSL sockets. This is null by
	 * default.
	 *
	 ...
	 * >Java Secure Socket Extension (JSEE) Reference Guide: Creating Your Own
	 * X509TrustManager</a>
	 *
	 * @param context
	 *            the custom SSLContext for new sockets
	 */
	...
	/**
	 * Set the HostnameVerifier used to verify the hostname of SSLSockets used
	 * by XMPP connections created with this ConnectionConfiguration.
	 * 
	 * @param verifier
	 */
	...
	/**
	 * Returns the configured HostnameVerifier of this ConnectionConfiguration
	 * or the Smack default HostnameVerifier configured with
	 ...
	 * debugged. By default the value of
	 * {@link SmackConfiguration#DEBUG_ENABLED} is used.
	 *
	 ...
	 * By default the value of {@link SmackConfiguration#DEBUG_ENABLED} is used.
	 *
	 ...
	 *
	 * @param isAllowed
	 *            if the reconnection mechanism should be enabled for this
	 *            connection.
	 */
	...
	/**
	 * Returns true if a {@link Session} will be requested on login if the
	 * server supports it. Although this was mandatory on RFC 3921, RFC
	 * 6120/6121 don't even mention this part of the protocol.
	 *
	...
	/**
	 * Sets if a {@link Session} will be requested on login if the server
	 * supports it. Although this was mandatory on RFC 3921, RFC 6120/6121 don't
	 * even mention this part of the protocol.
	 *
	 * @param legacySessionDisabled
	 *            if a session has to be requested when logging in.
	 */
	...
	private void initHostAddresses(String host, int port) {
		...
		// throw new
		// IllegalArgumentException("host must not be the empty String");
		// }
