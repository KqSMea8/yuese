...
public class tuiguangrenshu_01152 extends Activity implements OnClickListener {
			...
			switch(msg.what) {
				case 216:
					...
					if (pageno == 1 || pageno==0) {
						...
						adapter1 = new tuiguangrenshu_Adapter_01152(tuiguangrenshu_01152.this, l1, list1);
