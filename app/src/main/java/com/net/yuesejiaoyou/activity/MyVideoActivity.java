...
public class MyVideoActivity extends Activity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myvideoupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(MyVideoActivity.this, UploadVideo_01158.class);//编辑资料
...
//		thread.start();
                ...
                case 201:
                    ...
                    adapter.setOnItemClickLitsener(new VideoMyAdapter_01066.onItemClickListener() {
                        ...
                        public void onItemClick(View view, int position) {
                            Intent intent = new Intent(MyVideoActivity.this, VideoPlayActivity.class);
    ...
    public void showPopupspWindow2(View parent,final int position) {
        ...
        WindowManager.LayoutParams lp =  MyVideoActivity.this.getWindow().getAttributes();
        lp.alpha = 0.4f;
        MyVideoActivity.this.getWindow().setAttributes(lp);
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                WindowManager.LayoutParams lp = MyVideoActivity.this.getWindow().getAttributes();
                lp.alpha = 1f;
                MyVideoActivity.this.getWindow()
