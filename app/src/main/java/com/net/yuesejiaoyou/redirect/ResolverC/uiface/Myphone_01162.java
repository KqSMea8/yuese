...
import com.example.vliao.interface4.MyAdapter_01162;
...
/**********************************
 * openfire相关暂时注释，下面256行-280行为注释代码
 *********************************/
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				...
				case 200:
					...
					if (totlepage == 0) {
						//list1 = page.getList();
						//adapter = new MyAdapter_01162(null, Myphone_01162.this, false, list1);
					...
					if (pageno == 1) {
						...
						layoutManager = new GridLayoutManager(Myphone_01162.this, 1);
				...
				adapter.setOnItemClickLitsener(new MyAdapter_01162.onItemClickListener() {
						...
						public void onItemClick(View view, int position) {
							if(Util.iszhubo.equals("1")){
								...
								Intent intent = new Intent(Myphone_01162.this, ChatActivity.class);
					...
					if(!json.isEmpty()){
						try {
							...
							if(success_ornot.equals("1")){
								...
								GukeActivity.startCallZhubo(Myphone_01162.this, new ZhuboInfo(userid,username,userPhoto,timestamp, P2PVideoConst.GUKE_CALL_ZHUBO, P2PVideoConst.NONE_YUYUE));
...
//									Toast.makeText(Myphone_01162.this,"抱歉，你与你自己无法通话",Toast.LENGTH_LONG).show();
//								}else{
...
//								}
							...
							//The anchor is busy now,please try again later----主播现在很忙，请稍后再试。
								Toast.makeText(Myphone_01162.this, "主播现在很忙，请稍后再试。", Toast.LENGTH_SHORT).show();
								...
								Toast.makeText(Myphone_01162.this, "主播暂时不在，请稍后再试。", Toast.LENGTH_SHORT).show();
							}else if(success_ornot.equals("4")){
								/*showPopupspWindow4(mListView);*/
								Toast.makeText(Myphone_01162.this, "主播离线中", Toast.LENGTH_SHORT).show();
							}else if(success_ornot.equals("0")){
								//You don't have enough money to pay for this call--你的悦币余额不足以进行本次通话
								Toast.makeText(Myphone_01162.this, "你的悦币余额不足以进行本次通话", Toast.LENGTH_SHORT).show();
						...
						Toast.makeText(Myphone_01162.this, "请检查网络", Toast.LENGTH_SHORT).show();
					}
					break;
			}
		}
	...
	public void showPopupspWindow_chongzhi(View parent) {
		...
		confirm.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				 ...
				 *
				 **********************************/
				//intent1.setClass(Myphone_01162.this,Chongzhi_01178.class );//充值页面
